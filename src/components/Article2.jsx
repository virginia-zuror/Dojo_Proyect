...
const Article2 = () => {
  return (
    <Box
      ...
      paddingRight="8rem"
    >
      <Text fontSize="2xl">Shotokan Karate</Text>
      ...
      <Image
        src="https://res.cloudinary.com/do7bnejaz/image/upload/v1676839071/CobraKai%20_Gym/Examen-de-karate-en-Jap_C3_B3n-e1530724195278_i0sm3e.jpg"
        alt="Karate exam in Japan"
        minWidth="100%"
        maxHeight="250px"
        objectFit="cover"
      />
